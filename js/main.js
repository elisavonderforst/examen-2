...
var six = document.querySelector(".a-click");
...
var burgerMobile = function () {
  ...
  five.classList.toggle("is-close");
...
var burgerMobileClose = function () {
  three.classList.toggle("is-covert");
  seven.classList.toggle("is-visible");
  eight.classList.toggle("is-visible");
  nine.classList.toggle("is-visible");
  five.classList.toggle("is-visible");
  ten.classList.toggle("is-visible");
};

six.addEventListener("click", burgerMobileClose);
